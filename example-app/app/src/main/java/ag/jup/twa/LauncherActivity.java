...
public class LauncherActivity
    ...
    protected TwaLauncher createTwaLauncher() {
        // Try to use Chrome as the default browser if it's available on the device
        ...
        try {
            ...
            // Chrome is not installed; use null to fall back to default behavior
            chromePackage = null;
        }
        
        return new TwaLauncher(this, chromePackage, SessionStore.makeSessionId(getTaskId()),
